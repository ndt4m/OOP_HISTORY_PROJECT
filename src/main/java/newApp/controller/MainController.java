...
public class MainController {
    ...
    @FXML
    private FXMLLoader loadHomePage = new FXMLLoader(getClass().getResource("/newApp/trangchu.fxml"));
    ...
    void EraPressed(ActionEvent event) {
        FXMLLoader loadEra = new FXMLLoader(getClass().getResource("/newApp/Era.fxml"));
        try {
            eraBox = loadEra.load();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    void HisSitePressed(ActionEvent event) {
        FXMLLoader loadDiTich = new FXMLLoader(getClass().getResource("/newApp/DiTich.fxml"));
        try {
    ...
    void characterPressed(ActionEvent event) {
        FXMLLoader loadChar = new FXMLLoader(getClass().getResource("/newApp/Character.fxml"));
        try {
    ...
    void eventPressed(ActionEvent event) {
        FXMLLoader loadEvent = new FXMLLoader(getClass().getResource("/newApp/Event.fxml"));
        try {
    ...
    void festivalPressed(ActionEvent event) {
        FXMLLoader loadFes = new FXMLLoader(getClass().getResource("/newApp/Festival.fxml"));
        try {
            fesBox = loadFes.load();
        } catch (IOException e) {
            e.printStackTrace();
